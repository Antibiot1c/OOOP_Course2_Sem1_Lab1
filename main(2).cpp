...
public:
	...
	//-----------------------------------------------------------------------------------------------//
	// 
	// Àëãîðèòìè ñîðòóâàííÿ
	// Sorting algorithms
	//
	//-----------------------------------------------------------------------------------------------//


	//Insertion-Sort (Ñîðòóâàííÿ âñòàâêîþ) ----------------------------------------------------------
...
public:
	...
	//-----------------------------------------------------------------------------------------------//
	// 
	// Øâèäê³ àëãîðèòìè, íå çàñíîâàí³ íà ïîð³âíÿíí³ 
	// Fast algorithms, not based on comparison
	//
	//-----------------------------------------------------------------------------------------------//

	
	//Count-Sort (Ñîðòóâàííÿ çà ê³ëüê³ñòþ) -------------------------------------------------------------
	void CountSort() {
		int* output = new T1[n];
		int max = getMax(), i;
	...
	//Radix-Sort (Ïîðîçðÿäíå ñîðòóâàííÿ) -------------------------------------------------------------
...
void Menu() {
	cout << "--------------- Îáåð³òü ðåàë³çàö³þ: ---------------" << endl
		<< "(1) Îäíîçâ'ÿçíèé ñïèñîê" << endl
		<< "(2) Ìàñèâ" << endl
		<< "(3) Âåêòîð" << endl;
	cout << "---------------------------------------------------" << endl
		<< "(0) Çàâåðøèòè ðîáîòó" << endl;
	cout << "---------------------------------------------------" << endl;
	cout << "Âàø âèá³ð: " << endl;
	cin >> impl;
}
void Menu_Sort_(int& tsort) {
	cout << "--------------- Îáåð³òü ìåòîä ñîðòóâàííÿ äàíèõ: ---------------" << endl
		<< "(1) Insert sort" << endl
		<< "(2) Quick sort" << endl
		<< "(3) Merge sort" << endl;
	cout << "---------------------------------------------------" << endl;
...
int main() {
	...
	while (impl) {
		...
		case 1: system("cls");
			...
			cout << "--------------- Äàí³ ï³ñëÿ ñîðòóâàííÿ ---------------" << endl;
			list.printlist(list.head);
			after_case(); break;
		...
		case 3: system("cls");
			...
			after_case(); break;
		default:
			cout << "--------------- Íåïðàâèëüíî ââåäåíî êîä îïåðàö³¿! ---------------" << endl;
			after_case(); break;
		}
	}
	return 0;
